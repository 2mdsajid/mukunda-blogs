    ...
    return (
        ...
        <div className='w-full min-h-screen lg:pt-[14rem]  flex flex-col-reverse lg:flex-row items-center justify-center space-y-5 lg:space-y-0 lg:justify-between md:items-start'>
            <div className="w-full  lg:w-1/2 my-10 lg:my-0 lg:pr-10 md:pr-8 sm:pr-6">
                <h1 className='text-lg md:text-xl lg:text-3xl font-bold'>Hello from <span className='text-dark-accent font-bold tracking-wider font-poppins text-lg sm:text-xl md:text-3xl'>Mukund</span></h1>
                ...
                <div className='text-lg sm:text-xl md:text-3xl w-full font-bold my-1 lg:my-3'>
                    <div className='flex space-x-2 w-full'>
                        <TypewriterC texts={['MEDSTUDENT.', 'WRITER.', 'BIBLIOPHILE.']} />
                    </div>
                </div>
                {/* about me */}
                <p className='text-md md:text-xl my-2 md:my-10'>
                    As a second-year medical student enrolled at Manipal College of Medical Sciences located in Pokhara, I&apos;m deeply immersed in my studies. Alongside my dedication to pursuing a medical degree, I have a genuine fondness for the world of writing and literature.</p>
                <div className='flex flex-row space-x-4 mt-4 md:mt-10'>
                    <Link href="/about" className="p-2 border border-accent bg-dark-accent hover:bg-accent w-max rounded-lg font-semibold text-white ">
                        About Me
                    </Link>
